...
export const nouns: WordItem[][] = [
  ...
  [
    ...
    { word: "tree", icon: "leaf-outline" },
    { word: "fish", icon: "fish-outline" },
  ],
  ...
  [
    ...
    { word: "bread", icon: "restaurant-outline" },
    { word: "egg", icon: "egg-outline" },
  ],

  // LEVEL 3 — social & environment
  [
    { word: "school", icon: "school-outline" },
    { word: "teacher", icon: "person-outline" },
    { word: "student", icon: "person-circle-outline" },
    { word: "family", icon: "people-outline" },
    { word: "friend", icon: "heart-outline" },
    { word: "city", icon: "business-outline" },
    { word: "river", icon: "water-outline" },
    { word: "mountain", icon: "triangle-outline" },
    { word: "animal", icon: "paw-outline" },
    { word: "country", icon: "flag-outline" },
    { word: "music", icon: "musical-notes-outline" },
    { word: "picture", icon: "image-outline" },
    { word: "garden", icon: "leaf-outline" },
    { word: "market", icon: "storefront-outline" },
  ],

  // LEVEL 4 — technology & places
  [
    { word: "computer", icon: "laptop-outline" },
    { word: "internet", icon: "globe-outline" },
    { word: "library", icon: "library-outline" },
    { word: "hospital", icon: "medkit-outline" },
    { word: "restaurant", icon: "restaurant-outline" },
    { word: "airport", icon: "airplane-outline" },
    { word: "station", icon: "train-outline" },
    { word: "office", icon: "briefcase-outline" },
    { word: "factory", icon: "build-outline" },
    { word: "company", icon: "business-outline" },
    { word: "history", icon: "time-outline" },
    { word: "science", icon: "flask-outline" },
    { word: "language", icon: "chatbubble-ellipses-outline" },
  ...
  [
    ...
    { word: "mathematics", icon: "calculator-outline" },
    { word: "chemistry", icon: "flask-outline" },
    { word: "physics", icon: "planet-outline" },
    { word: "astronomy", icon: "telescope-outline" },
    { word: "geography", icon: "map-outline" },
    { word: "anthropology", icon: "people-outline" },
    { word: "sociology", icon: "people-circle-outline" },
  ],

  // LEVEL 7 — abstract & motivation
  [
    { word: "responsibility", icon: "shield-checkmark-outline" },
    { word: "opportunity", icon: "sparkles-outline" },
    { word: "communication", icon: "chatbubbles-outline" },
