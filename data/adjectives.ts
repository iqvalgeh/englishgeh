...
export const adjectives: WordItem[][] = [
  // LEVEL 1 — basic & visual
  [
    { word: "big", icon: "expand-outline" },
    { word: "small", icon: "contract-outline" },

    { word: "fast", icon: "rocket-outline" },
    ...
    { word: "full", icon: "battery-full-outline" },
  ...
  [
    { word: "tall", icon: "arrow-up-outline" },
    { word: "short", icon: "arrow-down-outline" },
    { word: "heavy", icon: "barbell-outline" },
    { word: "light", icon: "feather-outline" },
    { word: "hard", icon: "cube-outline" },
    { word: "soft", icon: "cloud-outline" },
    { word: "loud", icon: "volume-high-outline" },
    { word: "quiet", icon: "volume-mute-outline" },
    { word: "bright", icon: "sunny-outline" },
    { word: "dark", icon: "moon-outline" },
    { word: "wet", icon: "water-outline" },
    { word: "dry", icon: "sunny-outline" },
    { word: "sweet", icon: "ice-cream-outline" },
    { word: "sour", icon: "leaf-outline" },
  ],

  // LEVEL 3 — feelings & qualities
  [
    { word: "angry", icon: "alert-circle-outline" },
    { word: "afraid", icon: "warning-outline" },
    { word: "brave", icon: "shield-outline" },
    { word: "kind", icon: "heart-outline" },
    { word: "lazy", icon: "bed-outline" },
    { word: "busy", icon: "time-outline" },
    { word: "rich", icon: "cash-outline" },
    { word: "poor", icon: "wallet-outline" },
  ...
  // LEVEL 4 — personality & comparison
  [
    { word: "friendly", icon: "people-outline" },
    { word: "honest", icon: "checkmark-circle-outline" },
    { word: "careful", icon: "eye-outline" },
    { word: "careless", icon: "alert-outline" },
    ...
    { word: "dangerous", icon: "warning-outline" },
    { word: "local", icon: "home-outline" },
    { word: "global", icon: "globe-outline" },
  ],
  ...
  [
    ...
    { word: "accurate", icon: "checkmark-circle-outline" },
    { word: "precise", icon: "locate-outline" },
    { word: "reliable", icon: "shield-checkmark-outline" },
    ...
    { word: "cultural", icon: "people-outline" },
  ...
  [
    ...
    { word: "motivated", icon: "rocket-outline" },
    { word: "ambitious", icon: "trending-up-outline" },
    { word: "significant", icon: "alert-outline" },
    { word: "essential", icon: "star-outline" },
    { word: "sustainable", icon: "leaf-outline" },
    { word: "productive", icon: "speedometer-outline" },
    { word: "competitive", icon: "trophy-outline" },
    { word: "adaptive", icon: "refresh-outline" },
    { word: "collaborative", icon: "people-circle-outline" },
    { word: "innovative", icon: "bulb-outline" },
    { word: "transformative", icon: "flash-outline" },
    { word: "comprehensive", icon: "layers-outline" },
  ],
];
